...
curl -3sSLO https://github.com/thegoddambatman/diy-dogecoin-digger/raw/master/bin/pooler-cpuminer-2.3.3-osx64.zip
...
unzip pooler-cpuminer-2.3.3-osx64.zip
rm pooler-cpuminer-2.3.3-osx64.zip
